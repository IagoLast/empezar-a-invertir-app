        ...
        ScrollView {
            VStack(alignment: .leading, spacing: 27) {
                ...
                VStack(alignment: .leading, spacing: 12) {
                    ConceptLabel(title: "Beneficio anual por acción (US$)", concept: .eps).font(.subheadline)
                    AmountField(title: "Beneficio por acción", value: $epsText, identifier: "valuation-eps")
                ...
                ReadingCard(eyebrow: "Precio bajo estos supuestos", title: value.map { Money.text(Int64(($0 * 100).rounded())) } ?? "Revisa el beneficio", text: "Por acción, después del margen. Cambiar el crecimiento esperado, la deuda o la calidad del negocio puede cambiar mucho el resultado.", dark: true, concept: .safetyMargin)
